                ...
                <div class="post featured-post-xl">
                    <div class="details clearfix">
                        ...
                        <ul class="meta list-inline mb-0">
                            ...
                            <li class="list-inline-item">{{ Carbon\Carbon::parse($featured_post->created_at)->format('d F Y') }}</li>
                        </ul>
                    </div>
                    <a href="blog-single.html">
                        <div class="thumb rounded">
                            <div class="inner data-bg-image" data-bg-image="{{ asset('storage/post/'.$featured_post->featured_image) }}"></div>
                        </div>
                    </a>
                </div>
                @endforeach
				...
				<div class="col-lg-8">
					...
					<div class="post post-classic rounded bordered">
						<div class="thumb top-rounded">
							...
							<a href="blog-single.html">
								<div class="inner">
									<img src="{{ asset('storage/post/'.$post->featured_image) }}" alt="post-title"  class="img-fluid" style="width: 100%"/>
								</div>
							</a>
						</div>
						<div class="details">
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="classic.html#"><img src="{{ asset('storage/user/'.$post->user->profile) }}" class="author img-fluid rounded-circle" alt="author "  style="width: 50px; height: 50px; object-fit:cover; object-position:center; " />{{ $post->user->name }}</a></li>
								<li class="list-inline-item">{{ Carbon\Carbon::parse($featured_post->created_at)->format('d F Y') }}</li>
