...
<section class="main-content mt-3">
    <div class="container-xl">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="blog-single.html#">{{ $post->category->name }}</a></li>
                ...
                <div class="post post-single">
                    ...
                    <div class="post-header">
                        ...
                        <ul class="meta list-inline mb-0">
                            <li class="list-inline-item"><a href="blog-single.html#"><img src="{{ asset('storage/user/'.$post->user->profile) }}" class="author img-fluid rounded-circle" alt="author "
