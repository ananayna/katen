                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="post post-grid rounded bordered h-100">
                                    <div class="thumb top-rounded">
                                        <a href="{{ route('category', $post->category->slug) }}" class="category-badge position-absolute">{{ $post->category->name }}</a>
                                        <span class="post-format">
                                            <i class="icon-picture"></i>
                                        </span>
                                        <a href="{{ route('showPost', $post->slug) }}">
                                            <div class="inner">
                                                <img src="{{ asset('storage/post/'.$post->featured_image) }}" alt="post-title" class="img-fluid"
                                    ...
                                    <div class="details">
                                        <ul class="meta list-inline mb-0">
                                            <li class="list-inline-item"><a href="{{ route('category', $post->category->slug) }}"><img src="{{ asset('storage/user/'.$post->user->profile) }}" class="author img-fluid rounded-circle" alt="author "
                                                style="width: 50px; height: 50px; object-fit: cover; object-position: center; " />{{ $post->user->name }}</a></li>
                                    ...
                                    <div class="post-bottom clearfix d-flex align-items-center">
                                        ...
                                        <div class="more-button float-end">
                                            <a href="{{ route('showPost', $post->slug) }}"><span class="icon-options"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
