...
<div class="row">
              ...
              <table class="table striped-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('category.edit',$category->id ) }}" class="btn-sm main-btn info-btn btn-hober">
    ...
    <div class="col-lg-4">
        <div class="card-style mb-30">
            <h6 class="mb-25">{{ isset($editData) ? 'Update' :'Add new' }} category</h6>
            <form action="{{ isset($editData) ? route('category.update', $editData->id) : route('category.store') }}" method="POST">
                ...
                <div class="input-style-1">
                  ...
                  <!-- end input -->
                  <button type="submit" class="main-btn primary-btn btn-hover w-100 btn-sm">{{ isset($editData) ? 'Update' :'Add new' }} category</button>
                </div>
            </form>
    </div>
</div>
